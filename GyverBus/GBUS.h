...
/*
	...
	0	[GBUS_OFF]			- шина отключена
	1 	[GBUS_IDLE] 		- ожидание (холостой режим)
	2 	[TRANSMITTING] 		- передача
	3	[TX_OVERFLOW]		- буфер переполнен
	4 	[TX_COMPLETE] 		- передача завершена
	5 	[RECEIVING] 		- приём
	6	[RX_ERROR] 			- ошибка приёма
	7	[RX_ABORT] 			- ошибка. Приём прерван
	8 	[RX_OVERFLOW] 		- ошибка. Буфер или пакет переполнен
	9 	[RX_ADDRESS_ERROR] 	- ошибка. Не наш адрес
	10 	[RX_CRC_ERROR] 		- ошибка. Не совпадает CRC
	11 	[RX_REQUEST] 		- успешное получение запроса
	12 	[RX_DATA] 			- успешный приём данных
	13 	[RX_ACK]			- успешное получение подтверждения
*/
