 ...
 * Icons 8x8
 *
 * Эти иконки занимают всю высоту и ширину строки
 * соответственно между двумя иконками подряд не будет отступления
 * если использовать setCursor
 *
 * На Arduino не достаточно памяти для подключения (даже на Mega)
 * поэтому копируем те иконки которые нужно (смотрите сетч drawIcons)
 */
