...
void setup() {
  ...
  butt1.setTimeout(300);        // настройка времени удержания (по умолчанию 500 мс)
  butt2.setTimeout(300);        // настройка времени удержания (по умолчанию 500 мс)
  butt1.setStepTimeout(300);    // настройка интервала инкремента (по умолчанию 400 мс)
  butt2.setStepTimeout(300);    // настройка интервала инкремента (по умолчанию 400 мс)
}
