...
DateTime MicroDS3231::getTime() {
	DateTime now = (DateTime) {getSeconds(), getMinutes(), getHours(), getDay(), getDate(), getMonth(), getYear()};
	return now;
}
