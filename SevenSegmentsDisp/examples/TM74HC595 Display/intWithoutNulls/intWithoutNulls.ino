/*
   Простой пример вывода целых чисел (unsigned int / int),БЕЗ НУЛЕЙ СЛЕВА, на дисплей TM74HC595
...
void loop() {
  ...
  disp.displayInt(value);         // Вывод числа БЕЗ НУЛЕЙ СЛЕВА (минус следует за ближайшим числом)
