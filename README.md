...
<a id="GyverUART"></a>
### GyverUART v1.4 [СКАЧАТЬ](https://github.com/AlexGyver/GyverLibs/releases/download/GyverUART/GyverUART.zip)
...
- **uartPrint(val)** - печать в порт (числа, строки, char array). Через запятую - количество десятых у float и базис у int
